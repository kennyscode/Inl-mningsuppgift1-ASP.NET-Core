...
Startup.cs innehåller kod som bestämmer hur webbapplikationen ska fungera, det är här vi konfiguerar hur webb-appen ska ta hand om inkommande requests från View (det som är synligt och intergrerbart för användaren). Wwwroot är mappen där man placerar statiska filer, exempelvis rena html-filer, JavaScript-filer, och CSS-filer som man vill använda sig av i webb-appen. Det är alltså saker som ser likadana ut varje gång en användare frågar efter det. Razor språket
